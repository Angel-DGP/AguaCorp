...
import { View, Text, ScrollView, Platform, useWindowDimensions, TouchableOpacity } from 'react-native';
    ...
    >
      ...
      <AppCard>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: SPACING.lg }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: SPACING.sm }}>
            ...
            <View>
              <Text style={{ fontSize: FONT_SIZES.xl, fontWeight: FONT_WEIGHTS.bold, color: COLORS.darkBlue }}>Historial de Lecturas</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, marginBottom: SPACING.lg }}>
         ...
         >
           <BarChart
             ...
             width={Math.max(windowWidth - 20, labels.length * 80)}
             height={220}
             fromZero
      ...
      <View style={{ gap: SPACING.base }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, marginBottom: SPACING.sm }}>
          ...
          <Text style={{ fontSize: FONT_SIZES.lg, fontWeight: FONT_WEIGHTS.semibold, color: COLORS.darkBlue }}>Lecturas del Año</Text>
        </View>
